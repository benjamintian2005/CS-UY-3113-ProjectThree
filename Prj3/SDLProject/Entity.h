...
enum EntityType { PLATFORM, PLAYER, ENEMY , WIN,  LOSE};
...
public:
    ...
    Entity(GLuint texture_id, float speed, float width, float height, EntityType EntityType, GLuint font_id ); // Simpler constructor
    ...
    void stop_horizontal_thrust() { m_acceleration.x = 0.0f; }
    void stop_vertical_thrust() { m_acceleration.y = 0.0f; }
    ...
    bool      const get_won() const { return m_has_won; }
    bool      const get_lost() const { return m_has_lost; }
